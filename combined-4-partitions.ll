...
entry:
  ...
  %2 = tail call i32 @"\01_sleep"(i32 1) #6, !start !23, !end !24
  %3 = tail call i32 @"\01_sleep"(i32 1) #6, !start !25, !end !23
  %4 = tail call i32 @"\01_sleep"(i32 1) #6, !start !22, !end !25
...
entry:
  ...
  %1 = fmul double %receive, 4.000000e+00, !start !26, !end !27
  %receive1 = call double @receive(i32 0, i32 4, i8* %0)
  %2 = fmul double %1, %receive1, !start !27, !end !28
  %receive2 = call double @receive(i32 0, i32 5, i8* %0)
  %3 = fsub double %receive2, %2, !start !28, !end !29
  %4 = tail call double @llvm.sqrt.f64(double %3), !start !29, !end !30
  call void @send(double %4, i32 3, i32 8, i8* %0)
  %receive3 = call double @receive(i32 3, i32 11, i8* %0)
  %5 = fsub double %receive3, %4, !start !30, !end !23
  %receive4 = call double @receive(i32 1, i32 12, i8* %0)
  %6 = fdiv double %5, %receive4, !start !23, !end !24
...
entry:
  ...
  %1 = fmul double %receive, 2.000000e+00, !start !26, !end !27
  %2 = tail call i32 @"\01_sleep"(i32 1) #6, !start !27, !end !31
  %3 = tail call i32 @"\01_sleep"(i32 1) #6, !start !31, !end !32
  %4 = tail call i32 @"\01_sleep"(i32 1) #6, !start !33, !end !34
...
entry:
  %1 = tail call i32 @"\01_sleep"(i32 1) #6, !start !35, !end !36
  %2 = tail call i32 @"\01_sleep"(i32 1) #6, !start !21, !end !37
  %receive = call double @receive(i32 0, i32 7, i8* %0)
  %3 = fsub double -0.000000e+00, %receive, !start !37, !end !35
  %receive1 = call double @receive(i32 2, i32 8, i8* %0)
  %receive2 = call double @receive(i32 0, i32 9, i8* %0)
  %4 = fsub double %receive1, %receive2, !start !36, !end !38
  %receive3 = call double @receive(i32 1, i32 10, i8* %0)
  %5 = fdiv double %4, %receive3, !start !38, !end !39
  call void @send(double %3, i32 2, i32 11, i8* %0)
  %6 = fcmp une double %5, 0.000000e+00, !start !39, !end !40
  %receive4 = call double @receive(i32 2, i32 13, i8* %0)
  %7 = select i1 %6, double %5, double %receive4, !start !40, !end !34
  call void @send(double %7, i32 -1, i32 14, i8* %0), !start !34, !end !41
  ret void
}
