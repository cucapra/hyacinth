; ModuleID = 'c-examples/matrix_multiply.c'
source_filename = "c-examples/matrix_multiply.c"
...
define i32 @main(i32, i8** nocapture readnone) local_unnamed_addr #2 {
  ...
  call void @multiply([3 x double]* nonnull %9, [3 x double]* nonnull %10, [3 x double]* nonnull %11)
  br label %12
