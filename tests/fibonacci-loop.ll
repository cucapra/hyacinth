...
@comms_3 = global { i1, i1, i32 } zeroinitializer
...
entry:
  ...
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send_argument to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_0 to i64), i8* %1), !reason !9
  %return = call i8* bitcast (i8* (i32, i8*)* @receive_return to i8* (i64, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i8* %1), !reason !10
  %bitcast = bitcast i8* %return to i32*, !reason !10
...
entry:
  %argument = call i8* bitcast (i8* (i32, i64, i8*)* @receive_argument to i8* (i64, i64, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i64 ptrtoint ({ i32, i1, i32 }* @comms_0 to i64), i8* %0), !reason !9
  ...
  %1 = icmp sgt i32 %receive_load, 0, !partition !3
  %send_alloca5 = alloca i1, !reason !11
  store i1 %1, i1* %send_alloca5, !reason !11
  %send_cast6 = bitcast i1* %send_alloca5 to i8*, !reason !11
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast6, i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i1, i1, i32 }* @comms_2 to i64), i8* %0), !reason !11
  br i1 %1, label %l, label %l2

l:                                                ; preds = %l, %entry
  %new_phi = phi i32 [ %6, %l ], [ 0, %entry ]
  %new_phi3 = phi i32 [ %5, %l ], [ 1, %entry ]
  %new_phi4 = phi i32 [ %4, %l ], [ 0, %entry ]
  %2 = icmp ult i32 %new_phi, 2, !partition !3
  %3 = add nsw i32 %new_phi3, %new_phi4, !partition !3
  %4 = select i1 %2, i32 %new_phi4, i32 %new_phi3, !partition !3
  %5 = select i1 %2, i32 %new_phi3, i32 %3, !partition !3
  %6 = add nuw nsw i32 %new_phi, 1, !partition !3
  %7 = icmp eq i32 %6, %receive_load, !partition !3
  %send_alloca7 = alloca i1, !reason !11
  store i1 %7, i1* %send_alloca7, !reason !11
  %send_cast8 = bitcast i1* %send_alloca7 to i8*, !reason !11
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast8, i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i1, i1, i32 }* @comms_3 to i64), i8* %0), !reason !11
  br i1 %7, label %l1, label %l

l1:                                               ; preds = %l
  %8 = add i32 %receive_load, -1, !partition !3
  %9 = select i1 %2, i32 %8, i32 %3, !partition !3
  %send_alloca = alloca i32, !reason !12
  store i32 %9, i32* %send_alloca, !reason !12
  %send_cast = bitcast i32* %send_alloca to i8*, !reason !12
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i32, i1, i32 }* @comms_1 to i64), i8* %0), !reason !12
  br label %l2
...
entry:
  %broadcast = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i1, i1, i32 }* @comms_2 to i64), i8* %0), !reason !13
  %bitcast3 = bitcast i8* %broadcast to i1*, !reason !13
  %receive_load4 = load i1, i1* %bitcast3, !reason !13
  call void bitcast (void (i64, i32, i8*)* @free_comms to void (i64, i64, i8*)*)(i64 ptrtoint ({ i1, i1, i32 }* @comms_2 to i64), i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i8* %0), !reason !13
  br i1 %receive_load4, label %l, label %l2

l:                                                ; preds = %l, %entry
  %broadcast5 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i1, i1, i32 }* @comms_3 to i64), i8* %0), !reason !13
  %bitcast6 = bitcast i8* %broadcast5 to i1*, !reason !13
  %receive_load7 = load i1, i1* %bitcast6, !reason !13
  call void bitcast (void (i64, i32, i8*)* @free_comms to void (i64, i64, i8*)*)(i64 ptrtoint ({ i1, i1, i32 }* @comms_3 to i64), i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i8* %0), !reason !13
  br i1 %receive_load7, label %l1, label %l

l1:                                               ; preds = %l
  %repair_phi = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_1 to i64), i8* %0), !reason !13
  %bitcast = bitcast i8* %repair_phi to i32*, !reason !13
...
l2:                                               ; preds = %l1, %entry
  %new_phi = phi i32 [ %receive_load, %l1 ], [ 0, %entry ]
  %send_alloca = alloca i32, !reason !10
  store i32 %new_phi, i32* %send_alloca, !reason !10
  %send_cast = bitcast i32* %send_alloca to i8*, !reason !10
  call void bitcast (void (i8*, i32, i8*)* @send_return to void (i8*, i64, i8*)*)(i8* %send_cast, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i8* %0), !reason !10
  ret void
}
