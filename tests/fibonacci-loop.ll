...
entry:
  %argument = call i8* bitcast (i8* (i32, i32, i32, i8*)* @receive_argument to i8* (i64, i32, i32, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 -1, i32 8, i8* %0), !reason !3
...
l1:                                               ; preds = %l, %entry
  ...
  call void bitcast (void (i8*, i32, i32, i32, i8*)* @send to void (i8*, i64, i32, i32, i8*)*)(i8* %send_cast20, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 -1, i32 -1, i8* %0), !reason !15
  ret void
...
entry:
  ...
  call void bitcast (void (i8*, i32, i32, i32, i8*)* @send to void (i8*, i64, i32, i32, i8*)*)(i8* %send_cast2, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 1, i32 8, i8* %1), !reason !3
