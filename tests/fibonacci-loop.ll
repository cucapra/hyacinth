...
l:                                                ; preds = %l, %entry
  ...
  store i32 %new_phi3, i32* %send_alloca, !reason !15
  %send_cast = bitcast i32* %send_alloca to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i32, i1, i32 }* @comms_1 to i64), i8* %0), !reason !15
  %send_alloca4 = alloca i1, !reason !15
  store i1 %2, i1* %send_alloca4, !reason !15
  %send_cast5 = bitcast i1* %send_alloca4 to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast5, i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i1, i1, i32 }* @comms_2 to i64), i8* %0), !reason !15
  ...
  %receive = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i32, i1, i32 }* @comms_4 to i64), i8* %0), !reason !15
  %bitcast8 = bitcast i8* %receive to i32*, !reason !15
  %receive_load9 = load i32, i32* %bitcast8, !reason !15
  ...
  %send_alloca13 = alloca i32, !reason !15
  store i32 %4, i32* %send_alloca13, !reason !15
  %send_cast14 = bitcast i32* %send_alloca13 to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast14, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i32, i1, i32 }* @comms_6 to i64), i8* %0), !reason !15
  %send_alloca22 = alloca i32, !reason !16
  store i32 %3, i32* %send_alloca22, !reason !16
  %send_cast23 = bitcast i32* %send_alloca22 to i8*, !reason !16
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast23, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i32, i1, i32 }* @comms_10 to i64), i8* %0), !reason !16
...
l1:                                               ; preds = %l
  ...
  %send_alloca15 = alloca i1, !reason !15
  store i1 %2, i1* %send_alloca15, !reason !15
  %send_cast16 = bitcast i1* %send_alloca15 to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast16, i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i1, i1, i32 }* @comms_8 to i64), i8* %0), !reason !15
  %send_alloca17 = alloca i32, !reason !15
  store i32 %5, i32* %send_alloca17, !reason !15
  %send_cast18 = bitcast i32* %send_alloca17 to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast18, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i32, i1, i32 }* @comms_9 to i64), i8* %0), !reason !15
...
l:                                                ; preds = %l, %entry
  ...
  %receive = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_1 to i64), i8* %0), !reason !15
  %bitcast = bitcast i8* %receive to i32*, !reason !15
  ...
  %receive3 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i1, i1, i32 }* @comms_2 to i64), i8* %0), !reason !15
  %bitcast4 = bitcast i8* %receive3 to i1*, !reason !15
  %receive_load5 = load i1, i1* %bitcast4, !reason !15
  ...
  %receive6 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_3 to i64), i8* %0), !reason !15
  ...
  %send_cast = bitcast i32* %send_alloca to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_4 to i64), i8* %0), !reason !15
  %send_alloca9 = alloca i32, !reason !15
  store i32 %1, i32* %send_alloca9, !reason !15
  ...
  %receive11 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_6 to i64), i8* %0), !reason !15
  %bitcast12 = bitcast i8* %receive11 to i32*, !reason !15
  %receive_load13 = load i32, i32* %bitcast12, !reason !15
  ...
  %send_alloca24 = alloca i32, !reason !16
  store i32 %2, i32* %send_alloca24, !reason !16
  %send_cast25 = bitcast i32* %send_alloca24 to i8*, !reason !16
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast25, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_11 to i64), i8* %0), !reason !16
...
l1:                                               ; preds = %l
  %receive16 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i1, i1, i32 }* @comms_8 to i64), i8* %0), !reason !15
  %bitcast17 = bitcast i8* %receive16 to i1*, !reason !15
  %receive_load18 = load i1, i1* %bitcast17, !reason !15
  call void bitcast (void (i64, i32, i8*)* @free_comms to void (i64, i64, i8*)*)(i64 ptrtoint ({ i1, i1, i32 }* @comms_8 to i64), i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i8* %0), !reason !15
  %receive19 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_9 to i64), i8* %0), !reason !15
  %bitcast20 = bitcast i8* %receive19 to i32*, !reason !15
  %receive_load21 = load i32, i32* %bitcast20, !reason !15
  call void bitcast (void (i64, i32, i8*)* @free_comms to void (i64, i64, i8*)*)(i64 ptrtoint ({ i32, i1, i32 }* @comms_9 to i64), i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i8* %0), !reason !15
  %4 = select i1 %receive_load18, i32 %receive_load21, i32 %1, !partition !6, !start !3, !end !6
  %send_alloca26 = alloca i32, !reason !16
  store i32 %4, i32* %send_alloca26, !reason !16
  %send_cast27 = bitcast i32* %send_alloca26 to i8*, !reason !16
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast27, i64 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i32, i1, i32 }* @comms_12 to i64), i8* %0), !reason !16
  br label %l2
