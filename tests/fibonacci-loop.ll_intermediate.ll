; ModuleID = 'tests/fibonacci-loop.ll'
...
; <label>:3:                                      ; preds = %3, %1
  ...
  %7 = icmp ult i32 %4, 2, !partition !3, !start !5, !end !6
  %8 = add nsw i32 %5, %6, !partition !3, !start !6, !end !7
  %9 = select i1 %7, i32 %6, i32 %5, !partition !3, !start !7, !end !8
  %10 = select i1 %7, i32 %5, i32 %8, !partition !3, !start !8, !end !9
  %11 = add nuw nsw i32 %4, 1, !partition !3, !start !3, !end !4
  %12 = icmp eq i32 %11, %0, !partition !3, !start !4, !end !5
  br i1 %12, label %13, label %3

; <label>:13:                                     ; preds = %3
  %14 = add i32 %0, -1, !partition !3, !start !3, !end !4
  %15 = select i1 %7, i32 %14, i32 %8, !partition !4, !start !5, !end !6
  br label %16

; <label>:16:                                     ; preds = %13, %1
  %17 = phi i32 [ %15, %13 ], [ 0, %1 ], !partition !3, !start !4, !end !4
  ret i32 %17, !partition !4, !start !5, !end !5
}
