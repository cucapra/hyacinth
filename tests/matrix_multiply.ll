...
; <label>:6:                                      ; preds = %6, %3
  %7 = phi i64 [ 0, %3 ], [ %15, %6 ], !partition !3, !start !8, !end !8
  %8 = phi double [ 0.000000e+00, %3 ], [ %14, %6 ], !partition !3, !start !8, !end !8
  %9 = getelementptr inbounds [3 x [3 x double]], [3 x [3 x double]]* @a, i64 0, i64 %2, i64 %7, !partition !3, !start !9, !end !10
  %10 = load double, double* %9, align 8, !tbaa !4, !partition !3, !start !11, !end !8
  %11 = getelementptr inbounds [3 x [3 x double]], [3 x [3 x double]]* @b, i64 0, i64 %7, i64 %4, !partition !3, !start !10, !end !12
  %12 = load double, double* %11, align 8, !tbaa !4, !partition !3, !start !3, !end !11
  %13 = fmul double %10, %12, !partition !11, !start !13, !end !10
  %14 = fadd double %8, %13, !partition !11, !start !3, !end !8
  %15 = add nuw nsw i64 %7, 1, !partition !11, !start !8, !end !9
  %16 = icmp eq i64 %15, 3, !partition !3, !start !8, !end !9
  br i1 %16, label %17, label %6

; <label>:17:                                     ; preds = %6
  store double %14, double* %5, align 8, !tbaa !4, !partition !3, !start !3, !end !3
...
; <label>:23:                                     ; preds = %20
  ret void, !partition !3, !start !3, !end !11
}
...
entry:
  %send_alloca27 = alloca i1, !reason !14
  %send_alloca25 = alloca i1, !reason !14
  %send_alloca23 = alloca i1, !reason !14
  %send_alloca13 = alloca i64, !reason !15
  %send_alloca11 = alloca double, !reason !15
...
l2:                                               ; preds = %l2, %l1
  ...
  %3 = load double, double* %2, align 8, !tbaa !4, !partition !3, !start !11, !end !8
  %4 = getelementptr inbounds [3 x [3 x double]], [3 x [3 x double]]* @b, i64 0, i64 %new_phi7, i64 %new_phi6, !partition !3, !start !10, !end !12
  %5 = load double, double* %4, align 8, !tbaa !4, !partition !3, !start !3, !end !11
  ...
  store double %5, double* %send_alloca9, !reason !15
  ...
  store double %new_phi8, double* %send_alloca11, !reason !15
  %send_cast12 = bitcast double* %send_alloca11 to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast12, i64 ptrtoint (double* getelementptr (double, double* null, i32 1) to i64), i32 1, i64 ptrtoint ({ double, i1, i32 }* @comms_2 to i64), i8* %0), !reason !15
  store i64 %new_phi7, i64* %send_alloca13, !reason !15
  %send_cast14 = bitcast i64* %send_alloca13 to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast14, i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i64, i1, i32 }* @comms_3 to i64), i8* %0), !reason !15
  %receive = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i64, i1, i32 }* @comms_4 to i64), i8* %0), !reason !15
  ...
  %6 = icmp eq i64 %receive_load, 3, !partition !3, !start !8, !end !9
  ...
  %bitcast18 = bitcast i8* %repair_phi to i64*, !reason !16
  %receive_load19 = load i64, i64* %bitcast18, !reason !16
  ...
  %repair_phi20 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (double* getelementptr (double, double* null, i32 1) to i64), i32 1, i64 ptrtoint ({ double, i1, i32 }* @comms_7 to i64), i8* %0), !reason !16
  %bitcast21 = bitcast i8* %repair_phi20 to double*, !reason !16
  %receive_load22 = load double, double* %bitcast21, !reason !16
  ...
  store i1 %6, i1* %send_alloca23, !reason !14
  %send_cast24 = bitcast i1* %send_alloca23 to i8*, !reason !14
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast24, i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i1, i1, i32 }* @comms_8 to i64), i8* %0), !reason !14
  br i1 %6, label %l3, label %l2

l3:                                               ; preds = %l2
  %receive15 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (double* getelementptr (double, double* null, i32 1) to i64), i32 1, i64 ptrtoint ({ double, i1, i32 }* @comms_5 to i64), i8* %0), !reason !15
  %bitcast16 = bitcast i8* %receive15 to double*, !reason !15
  %receive_load17 = load double, double* %bitcast16, !reason !15
  call void bitcast (void (i64, i32, i8*)* @free_comms to void (i64, i64, i8*)*)(i64 ptrtoint ({ double, i1, i32 }* @comms_5 to i64), i64 ptrtoint (double* getelementptr (double, double* null, i32 1) to i64), i8* %0), !reason !15
  store double %receive_load17, double* %1, align 8, !tbaa !4, !partition !3, !start !3, !end !3
  %7 = add nuw nsw i64 %new_phi6, 1, !partition !3, !start !3, !end !3
  %8 = icmp eq i64 %7, 3, !partition !3, !start !3, !end !3
  store i1 %8, i1* %send_alloca25, !reason !14
  %send_cast26 = bitcast i1* %send_alloca25 to i8*, !reason !14
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast26, i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i1, i1, i32 }* @comms_9 to i64), i8* %0), !reason !14
...
l4:                                               ; preds = %l3
  ...
  store i1 %10, i1* %send_alloca27, !reason !14
  %send_cast28 = bitcast i1* %send_alloca27 to i8*, !reason !14
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast28, i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 1, i64 ptrtoint ({ i1, i1, i32 }* @comms_10 to i64), i8* %0), !reason !14
...
entry:
  %send_alloca19 = alloca double, !reason !17
  %send_alloca17 = alloca i64, !reason !17
  %send_alloca15 = alloca double, !reason !15
...
l2:                                               ; preds = %l2, %l1
  ...
  %1 = fmul double %receive_load, %receive_load8, !partition !11, !start !13, !end !10
  %receive9 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (double* getelementptr (double, double* null, i32 1) to i64), i32 0, i64 ptrtoint ({ double, i1, i32 }* @comms_2 to i64), i8* %0), !reason !15
  ...
  %2 = fadd double %receive_load11, %1, !partition !11, !start !3, !end !8
  %receive12 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i64, i1, i32 }* @comms_3 to i64), i8* %0), !reason !15
  %bitcast13 = bitcast i8* %receive12 to i64*, !reason !15
  %receive_load14 = load i64, i64* %bitcast13, !reason !15
  call void bitcast (void (i64, i32, i8*)* @free_comms to void (i64, i64, i8*)*)(i64 ptrtoint ({ i64, i1, i32 }* @comms_3 to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64), i8* %0), !reason !15
  %3 = add nuw nsw i64 %receive_load14, 1, !partition !11, !start !8, !end !9
  store i64 %3, i64* %send_alloca, !reason !15
  %send_cast = bitcast i64* %send_alloca to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast, i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i64, i1, i32 }* @comms_4 to i64), i8* %0), !reason !15
  store i64 %3, i64* %send_alloca17, !reason !17
  %send_cast18 = bitcast i64* %send_alloca17 to i8*, !reason !17
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast18, i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i64, i1, i32 }* @comms_6 to i64), i8* %0), !reason !17
  store double %2, double* %send_alloca19, !reason !17
  %send_cast20 = bitcast double* %send_alloca19 to i8*, !reason !17
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast20, i64 ptrtoint (double* getelementptr (double, double* null, i32 1) to i64), i32 0, i64 ptrtoint ({ double, i1, i32 }* @comms_7 to i64), i8* %0), !reason !17
  %broadcast = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i1, i1, i32 }* @comms_8 to i64), i8* %0), !reason !16
  %bitcast21 = bitcast i8* %broadcast to i1*, !reason !16
  %receive_load22 = load i1, i1* %bitcast21, !reason !16
...
l3:                                               ; preds = %l2
  store double %2, double* %send_alloca15, !reason !15
  %send_cast16 = bitcast double* %send_alloca15 to i8*, !reason !15
  call void bitcast (void (i8*, i32, i32, i64, i8*)* @send to void (i8*, i64, i32, i64, i8*)*)(i8* %send_cast16, i64 ptrtoint (double* getelementptr (double, double* null, i32 1) to i64), i32 0, i64 ptrtoint ({ double, i1, i32 }* @comms_5 to i64), i8* %0), !reason !15
  %broadcast23 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i1, i1, i32 }* @comms_9 to i64), i8* %0), !reason !16
  %bitcast24 = bitcast i8* %broadcast23 to i1*, !reason !16
...
l4:                                               ; preds = %l3
  %broadcast26 = call i8* bitcast (i8* (i32, i32, i64, i8*)* @receive to i8* (i64, i32, i64, i8*)*)(i64 ptrtoint (i1* getelementptr (i1, i1* null, i32 1) to i64), i32 0, i64 ptrtoint ({ i1, i1, i32 }* @comms_10 to i64), i8* %0), !reason !16
  %bitcast27 = bitcast i8* %broadcast26 to i1*, !reason !16
